...
exports.setBech32Prefix = exports.setBech32NetworkPrefix = exports.bech32Prefix = void 0;
...
function setBech32NetworkPrefix(value) {
    exports.bech32Prefix.accAddr = value;
    exports.bech32Prefix.accPub = value + prefix_1.AddressPrefix.Public;
    exports.bech32Prefix.valAddr = value + prefix_1.AddressPrefix.Validator + prefix_1.AddressPrefix.Operator;
    exports.bech32Prefix.valPub = value + prefix_1.AddressPrefix.Validator + prefix_1.AddressPrefix.Operator + prefix_1.AddressPrefix.Public;
    exports.bech32Prefix.consAddr = value + prefix_1.AddressPrefix.Validator + prefix_1.AddressPrefix.Consensus;
    exports.bech32Prefix.consPub = value + prefix_1.AddressPrefix.Validator + prefix_1.AddressPrefix.Consensus + prefix_1.AddressPrefix.Public;
}
exports.setBech32NetworkPrefix = setBech32NetworkPrefix;
